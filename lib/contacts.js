        ...
        contact.hasLocalPhoneNumber(function (err, has) {
          if (contact.mainEmail(false)) {
            ...
            Profile.findById(contact._profile, function (err, profile) {
              var template = 'reminder_checkin';
              if (profile.isOrphan()) {
                template = 'reminder_checkin_orphan';
              }
              // Send mail
...
// Remove contacts which have expired (never been claimed)
...
// Remove profiles which have expired (never been claimed)
...
exports.deleteExpiredContacts = deleteExpiredContacts;
exports.deleteExpiredProfiles = deleteExpiredProfiles;
